    ...
    return {
      ...
      alignment: {
        ...
        renderHTML: (attributes: { alignment?: string | null }) => {
          ...
          const style = attributes.alignment ? styleMap[attributes.alignment] : undefined;
          return style ? { style, "data-alignment": attributes.alignment } : {};
        },
      },
    };
  },
...
export function Editor({
  ...
  useEffect(() => {
    ...
    const updateTableContext = () => {
      ...
      setImageAlignmentState(
        nextIsOnImage ? (editor.getAttributes("image")["alignment"] ?? null) : null
      );
    };
            ...
            {isOnImage ? (
              <>
                ...
                {renderIconButton({
                  label: "Align left",
                  icon: AlignLeft,
                  onClick: () => setImageAlignment(imageAlignment === "left" ? null : "left"),
                  disabled,
                  toggle: true,
                  pressed: imageAlignment === "left",
                })}
                {renderIconButton({
                  label: "Align center",
                  icon: AlignCenter,
                  onClick: () => setImageAlignment(imageAlignment === "center" ? null : "center"),
                  disabled,
                  toggle: true,
                  pressed: imageAlignment === "center",
                })}
                {renderIconButton({
                  label: "Align right",
                  icon: AlignRight,
                  onClick: () => setImageAlignment(imageAlignment === "right" ? null : "right"),
                  disabled,
                  toggle: true,
                  pressed: imageAlignment === "right",
                })}
                <span className="bg-border mx-0.5 h-4 w-px" aria-hidden="true" />
                <button
                  type="button"
