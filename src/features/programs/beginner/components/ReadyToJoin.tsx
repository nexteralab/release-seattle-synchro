...
import readyToJoin from '/images/ready_to_join_1.png'

export function ReadyToJoin() {
    return (
        <section
            className="relative py-24 px-12 md:px-48 bg-[#0A0A67] overflow-hidden min-h-[430px]"
            aria-labelledby="ready-to-join-heading"
        >
            {/* Content — centered, capped width so it doesn't overlap the illustration */}
            <div className="relative z-10 flex flex-col items-center text-center gap-6">
                <h2
                    id="ready-to-join-heading"
                    className="font-bold text-white text-[48px] tracking-[-2.4px] uppercase"
                >
                    Ready to Join?
                </h2>
                <p className="text-white/80 text-[20px] leading-[32px]">
                    Sign up for one of our competitive programs and discover the joy of artistic swimming.
                </p>
                <Link
                    to="/contact-us"
            ...
            <img
                ...
                alt="Ready to Join"
                aria-hidden="true"
                className="hidden md:block absolute bottom-[-100px] right-[-48px] h-full w-auto object-contain object-bottom pointer-events-none opacity-50"
            />
        </section>
    )
}