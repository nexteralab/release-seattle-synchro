...
export function SportPsychologyHero() {
    return (
        <section
            className="relative flex items-center justify-center overflow-hidden"
            style={{ minHeight: "50vh", background: "#0A0A67" }}
            aria-label="Sport Psychology hero"
        >
            ...
            <motion.div
                ...
                className="relative z-10 flex flex-col items-center text-center px-12 md:px-48 py-24 gap-8"
            >
                <motion.h1
                ...
                >
                    <blockquote
                        className="italic text-white/80 text-center max-w-xl"
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "18px", lineHeight: "28px" }}
                    >
                        "Wisdom is always an overmatch for strength"
                    </blockquote>
                    <figcaption
                        className="text-white/55"
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", letterSpacing: "1px" }}
                    >
                        — Phil Jackson
                    </figcaption>
                </motion.figure>
