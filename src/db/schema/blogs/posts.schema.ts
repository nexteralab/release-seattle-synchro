...
export const posts = pgTable('posts', {
  ...
  slug: text('slug').notNull().unique(),       // URL: /blog/mi-primer-post
  ...
  meta_title: text('meta_title'),           // override del <title> si se necesita
  meta_description: text('meta_description'),     // override del meta description
